...
INSERT INTO `gen_table` VALUES (1,'tb_course','课程管理',NULL,NULL,'Course','crud','element-plus','com.ruoyi.course','course','course','课程管理','sjn','0','/','{\"parentMenuId\":\"\"}','admin','2024-09-26 17:15:49','','2024-09-28 19:32:51',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='代码生成业务表字段';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `gen_table_column` VALUES (1,1,'id','课ID','bigint','Long','id','1','0','0','0',NULL,'1',NULL,'EQ','input','',1,'admin','2024-09-26 17:15:49','','2024-09-28 19:32:51'),(2,1,'code','课程码','varchar(32)','String','code','0','0','1','1','1','1','1','EQ','input','',2,'admin','2024-09-26 17:15:49','','2024-09-28 19:32:51'),(3,1,'subject','课程学科','varchar(64)','String','subject','0','0','1','1','1','1','1','EQ','select','course_subject',3,'admin','2024-09-26 17:15:49','','2024-09-28 19:32:51'),(4,1,'name','课程名称','varchar(64)','String','name','0','0','1','1','1','1','1','LIKE','input','',4,'admin','2024-09-26 17:15:49','','2024-09-28 19:32:51'),(5,1,'price','价格（元）','int','Long','price','0','0','1','1','1','1','0','EQ','input','',5,'admin','2024-09-26 17:15:49','','2024-09-28 19:32:51'),(6,1,'applicable_person','适用人群','varchar(32)','String','applicablePerson','0','0','1','1','1','1','1','EQ','input','',6,'admin','2024-09-26 17:15:49','','2024-09-28 19:32:51'),(7,1,'info','课程介绍','varchar(255)','String','info','0','0','0','1','1','1','0','EQ','input','',7,'admin','2024-09-26 17:15:49','','2024-09-28 19:32:51'),(8,1,'create_time','创建时间','timestamp','Date','createTime','0','0','0','0',NULL,NULL,NULL,'EQ','datetime','',8,'admin','2024-09-26 17:15:49','','2024-09-28 19:32:51'),(9,1,'update_time','更新时间','timestamp','Date','updateTime','0','0','0','0','0',NULL,NULL,'EQ','datetime','',9,'admin','2024-09-26 17:15:49','','2024-09-28 19:32:51');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_logininfor` VALUES (1,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-09-28 20:19:35'),(2,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-09-29 14:03:48');
...
-- Dump completed on 2024-09-29 15:40:11
