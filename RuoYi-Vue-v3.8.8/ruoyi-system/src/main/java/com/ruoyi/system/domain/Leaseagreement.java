...
public class Leaseagreement extends BaseEntity
{
    ...
    /** 合同类型 */
    @Excel(name = "合同类型")
    private String agreementTypeAll;
    ...
    public void setAgreementTypeAll(String agreementTypeAll) 
    {
        this.agreementTypeAll = agreementTypeAll;
    }

    public String getAgreementTypeAll() 
    {
        return agreementTypeAll;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("agreementTypeAll", getAgreementTypeAll())
            .toString();
    }
}
